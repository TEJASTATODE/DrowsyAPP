    ...
    <div className="w-full h-full flex items-center justify-center text-gray-400">
        Camera feed unavailable
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Card className="p-5 border-slate-200 shadow-sm bg-white rounded-2xl"><CleanMetric label="Eye Closure" value={status.ear} max={0.4} threshold={0.25} inverse={false} icon={RiEyeLine} /></Card>
                    <Card className="p-5 border-slate-200 shadow-sm bg-white rounded-2xl"><CleanMetric label="Yawning" value={status.mar} max={0.8} threshold={0.65} inverse={true} icon={TbFaceId} /></Card>
                    <Card className="p-5 border-slate-200 shadow-sm bg-white rounded-2xl"><CleanMetric label="Head Tilt" value={Math.abs(status.tilt)} max={45} threshold={20} inverse={true} unit="°" icon={RiFocus3Line} /></Card>
                </div>
            </div>
